...
git clone https://github.com/nantayo/passwall package/luci-app-passwall
...
################################################################################################################
Diy_all() {
git clone --depth 1 -b "${REPO_BRANCH}" https://github.com/YLEDE/openwrt-package "${Home}"/openwrt-package
